...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-gradient-to-b from-gray-800 to bg-navy p-4 text-white'>
        ...
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/blljzkrb" method='POST' className='flex flex-col w-full md:w-/2'>
                    ...
                    bg-transparent border-2 rounded-md text-white focus:outline-none ' />
                     ...
                     <input type="text" name='email'  placeholder='Enter your email' className='my-4 p-2 
                    bg-transparent border-2 rounded-md text-white focus:outline-none ' />
