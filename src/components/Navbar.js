...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center w-full h-20 text-white fixed bg-navy px-4'>
        <div>
            <h1 className='text-5xl ml-2'><img src={logo} alt="" /></h1>
        </div>
        ...
        <ul className='hidden md:flex'>
            ...
            {links.map(({id, link}) => (
                ...
                font-medium text-white-105 hover:scale-105 duration-200'
                >
        ...
        {nav && (
             ...
             left-0 w-full h-screen bg-gradient-to-b from-navy to-gray-800 '>
